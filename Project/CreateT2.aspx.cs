...
public partial class CreateT2 : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            path = Server.MapPath("~\\images2\\");
            FileUpload1.SaveAs(path + image);
            Image1.ImageUrl = "images2\\" + image;
        }
        catch (Exception ep)
        {
