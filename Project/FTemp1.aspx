<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FTemp1.aspx.cs" Inherits="FTemp1" %>
        ...
        <div id="content">
        	  ...
        	  <div class="scrollContainer">
                <div class="panel" id="home">
                	...
                	<h2><center><asp:Label ID="Label2" runat="server" Text="Welcome to" 
                            ForeColor="White"></asp:Label>
                            <asp:Label ID="Label14" runat="server" Text="[Name]" 
