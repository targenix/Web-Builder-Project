    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        if (check() == "OK")
        {
            if (passCheck() == "OK")
            {
                ...
                con.ConnectionString = @"Data Source=ARCHANA\SQLEXPRESS;Initial Catalog=Webpage;Integrated Security=TrueData Source=DESKTOP-U3V17HN\SQLEXPRESS;Initial Catalog=Webpage;Integrated Security=True";
                con.Open();
                SqlCommand cmd = new SqlCommand("insert into Cust(UId,Name,Address,Pass,Email,Mobile) values (@UserID,@Name,@Address,@Pass,@EMail,@Mobile);", con);
