<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CreateT2.aspx.cs" Inherits="CreateT2" %>
        ...
        <tr>
            <td align="center">
                ...
                <asp:Label ID="Label1" runat="server" Font-Size="XX-Large" Font-Underline="True" 
                    Text="Template 2" ForeColor="#1AA8D3"></asp:Label>
                <br />
                <br />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <tr>
            <td align="center">
                <iframe id="Temp1" src="Template2.aspx" width="95%" align="middle"></iframe>
            </td>
        </tr>
    </table>
</div>
