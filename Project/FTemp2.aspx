<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FTemp2.aspx.cs" Inherits="FTemp2" %>
        ...
        <div id="tooplate_main" >
        	...
        	<div id="menu">
                <ul class="navigation">
                    ...
                    <li><a href="#about"><asp:Label ID="P1" runat="server" Text="Welcome to" 
                            ForeColor="#7E6B4C"></asp:Label><span class="ui_icon aboutus"></span></a></li>
                    <li><a href="#services"><asp:Label ID="P2" runat="server" Text="Welcome to" 
                            ForeColor="#7E6B4C"></asp:Label><span class="ui_icon services"></span></a></li>
                ...
                <div class="scroll">
                    <div class="scrollContainer">
                        ...
                        <div class="panel" id="home">
                                <center><h2> <asp:Label ID="Label2" runat="server" Text="Welcome to" 
                            ForeColor="#7E6B4C"></asp:Label><asp:Label ID="Label14" runat="server" Text="Welcome To " 
